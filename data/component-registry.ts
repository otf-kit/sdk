...
// Storybook sanitize: lowercase, replace non-alphanumeric → '-', collapse, trim
// Title 'Charts/AreaChart' → 'charts-areachart'  (NOT 'charts-area-chart')
// Title 'Data/DataGrid'    → 'data-datagrid'     (NOT 'data-data-grid')
// Title 'Forms/Controls'   → 'forms-controls'
export const components: ComponentMeta[] = [
  // ── Primitives/Button ────────────────────────────────────────────────────────
  { slug: 'button',        name: 'Button',        description: 'Solid, outline, ghost, and destructive variants with icon and loading state support.',       category: 'Input',    tags: ['action', 'cta', 'form'],           hasExample: true, storybookId: 'primitives-button--all-variants' },
  // ── Primitives/Display ───────────────────────────────────────────────────────
  ...
  { slug: 'card',          name: 'Card',          description: 'Composable card with header, title, description, content, and footer slots.',                category: 'Layout',   tags: ['container', 'surface', 'panel'],   hasExample: true, storybookId: 'primitives-display--card-story' },
  { slug: 'progress',      name: 'Progress',      description: 'Progress bar for task completion, upload progress, and loading states.',                      category: 'Feedback', tags: ['loading', 'status'],               hasExample: true, storybookId: 'primitives-display--progress-story' },
  ...
  // ── Primitives/Skeleton ──────────────────────────────────────────────────────
  { slug: 'skeleton',      name: 'Skeleton',      description: 'Layout-mirroring skeleton loaders for async content — never plain spinners.',                category: 'Feedback', tags: ['loading', 'placeholder', 'ux'],    hasExample: true, storybookId: 'primitives-skeleton--card-skeleton' },
  // ── Primitives/Dialog ────────────────────────────────────────────────────────
  ...
  // ── Overlays/All ─────────────────────────────────────────────────────────────
  { slug: 'tooltip',       name: 'Tooltip',       description: 'Hover tooltip with configurable delay, placement, and content.',                             category: 'Display',  tags: ['hint', 'helper'],                  hasExample: true, storybookId: 'overlays-all--tooltip-demo' },
  { slug: 'popover',       name: 'Popover',       description: 'Floating popover with configurable placement and focus management.',                         category: 'Display',  tags: ['overlay', 'floating'],             hasExample: true, storybookId: 'overlays-all--popover-demo' },
  { slug: 'sheet',         name: 'Sheet',         description: 'Slide-in panel from any edge with backdrop overlay.',                                         category: 'Feedback', tags: ['drawer', 'panel', 'sidebar'],      hasExample: true, storybookId: 'overlays-all--sheet-demo' },
  // ── Forms/Controls ───────────────────────────────────────────────────────────
  ...
  // ── Forms/Combobox ───────────────────────────────────────────────────────────
  { slug: 'combobox',      name: 'Combobox',      description: 'Autocomplete combo box with searchable options and keyboard navigation.',                    category: 'Input',    tags: ['autocomplete', 'search', 'form'],  hasExample: true, storybookId: 'forms-combobox--default' },
  // ── Forms ────────────────────────────────────────────────────────────────────
  ...
  // ── AppShell/Sidebar ─────────────────────────────────────────────────────────
  { slug: 'sidebar',       name: 'Sidebar',       description: 'Collapsible navigation sidebar with groups, icons, badges, and responsive behavior.',        category: 'Layout',   tags: ['navigation', 'sidebar', 'nav'],    hasExample: true, storybookId: 'appshell-sidebar--default' },
  // ── Data Display ─────────────────────────────────────────────────────────────
  ...
  // ── Data/DataGrid — title 'Data/DataGrid' → 'data-datagrid' ─────────────────
  { slug: 'data-grid',     name: 'Data Grid',     description: 'Advanced data grid with row selection, column visibility, and virtual scrolling.',           category: 'Data',     tags: ['table', 'tanstack', 'virtual'],    hasExample: true, storybookId: 'data-datagrid--basic' },
  // ── Components/EmptyState ────────────────────────────────────────────────────
  { slug: 'empty-state',   name: 'Empty State',   description: 'Illustration + heading + call-to-action for empty data views.',                              category: 'Feedback', tags: ['empty', 'placeholder', 'zero'],    hasExample: true, storybookId: 'components-emptystate--default' },
  // ── Charts/AreaChart — title 'Charts/AreaChart' → 'charts-areachart' ────────
  { slug: 'area-chart',    name: 'Area Chart',    description: 'Smooth gradient area chart built on Recharts with configurable series, tooltip, and legend.',category: 'Data',     tags: ['chart', 'recharts', 'analytics'],  hasExample: true, storybookId: 'charts-areachart--multi-key' },
  { slug: 'bar-chart',     name: 'Bar Chart',     description: 'Grouped and stacked bar chart built on Recharts with custom tooltip.',                       category: 'Data',     tags: ['chart', 'recharts', 'bar'],        hasExample: true, storybookId: 'charts-areachart--bar-basic' },
  { slug: 'line-chart',    name: 'Line Chart',    description: 'Multi-series line chart with dot markers, legend, and tooltip.',                             category: 'Data',     tags: ['chart', 'recharts', 'line'],       hasExample: true, storybookId: 'charts-areachart--line-basic' },
  { slug: 'sparkline',     name: 'Sparkline',     description: 'Compact inline trend chart for embedding in stat cards and tables.',                         category: 'Data',     tags: ['chart', 'mini', 'trend'],          hasExample: true, storybookId: 'charts-areachart--sparkline-line' },
  // ── Advanced ─────────────────────────────────────────────────────────────────
  ...
  { slug: 'bulk-actions',  name: 'Bulk Actions',  description: 'Floating action bar that appears when rows are selected, with configurable action buttons.',  category: 'Input',    tags: ['table', 'selection', 'actions'],   hasExample: true, storybookId: 'advanced--bulk-actions-story' },
  { slug: 'filters',       name: 'Filters',       description: 'Composable filter builder for data tables with text, select, and number filter types.',       category: 'Input',    tags: ['filter', 'table', 'query'],        hasExample: true, storybookId: 'advanced--filters-story' },
  { slug: 'command-bar',   name: 'Command Bar',   description: 'Keyboard-driven command bar (⌘K) with grouped actions, search, and keyboard shortcuts.',     category: 'Input',    tags: ['keyboard', 'search', 'cmdk'],     hasExample: true, storybookId: 'advanced--command-bar-story' },
  ...
  { slug: 'workspace-members',       name: 'Workspace Members',  description: 'Team member management table with roles, permissions, and invite actions.',          category: 'Layout',   tags: ['team', 'members', 'settings'],     hasExample: true, storybookId: 'blocks--members-settings' },
  ...
  { slug: 'split-page',       name: 'Split Page',       description: 'Two-panel layout with resizable list and detail panes for email/file browsers.',   category: 'Layout',   tags: ['list', 'detail', 'layout'],        hasExample: true, storybookId: 'layouts--split-page-layout' },
  ...
  // ── Data/Lists ───────────────────────────────────────────────────────────────
  { slug: 'structured-list',  name: 'Structured List', description: 'Sectioned settings-style list with icons, descriptions, and right-side content.',   category: 'Display',  tags: ['settings', 'list', 'menu'],        hasExample: true, storybookId: 'data-lists--settings-list' },
  // ── Misc without storybook story ─────────────────────────────────────────────
