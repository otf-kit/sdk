...
export const components: ComponentMeta[] = [
  ...
  // ── Charts/AreaChart → chartsareachart ───────────────────────────────────
  { slug: 'area-chart',    name: 'Area Chart',    description: 'Smooth gradient area chart built on Recharts with series, tooltip, and legend.',              category: 'Data',     tags: ['chart', 'recharts', 'analytics'],  hasExample: true, storybookId: 'charts-areachart--multi-key' },
  ...
  // ── Feedback/Banner,LoadingOverlay,Stepper → feedback-banner-loadingoverlay-stepper
  { slug: 'banner',        name: 'Banner',        description: 'Alert banner with info, success, warning, error, and neutral variants plus dismiss.',          category: 'Feedback', tags: ['alert', 'notification', 'status'], hasExample: true, storybookId: 'feedback-banner-loadingoverlay-stepper--banner-all-variants' },
  { slug: 'stepper',       name: 'Stepper',       description: 'Multi-step progress indicator for forms, onboarding, and wizards.',                           category: 'Layout',   tags: ['wizard', 'steps', 'onboarding'],   hasExample: true, storybookId: 'feedback-banner-loadingoverlay-stepper--stepper-step-1' },
