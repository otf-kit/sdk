...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <DialogPrimitive.Content ref={ref} data-slot="sheet" className={cn(sheetVariants({ side }), className)} {...props}>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} data-slot="sheet-description" className={cn('text-sm text-[hsl(var(--muted-foreground))]', className)} {...props} />
))
