...
const testimonials: Testimonial[] = [
  ...
  { name: 'Rajiv Singh',    handle: '@rjv_im',         role: 'Indie Hacker',           text: 'The cleanest extension to shadcn I\'ve seen this year. Composability is top tier and the AI configs just work.', rating: 5 },
  ...
  { name: 'Joel Hooks',     handle: '@joelhooks',      role: 'Co-founder, egghead',    text: 'OTF fills the gap between primitives and finished UI. The AI configs for Cursor are outstanding — context works from day one.', rating: 5 },
